...
FROM ubuntu:22.04
RUN useradd -r gridvis -u 101 && apt update && apt -y install --no-install-recommends openjdk-21-jre fontconfig fonts-freefont-ttf xvfb libgtk-3-0 libxss1 libgbm1 && rm -rf /var/lib/apt/lists/*
